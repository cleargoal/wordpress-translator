...
class Admin
{
    ...
    public function init(): void
    {
        ...
        add_action('wp_ajax_wpste_translate_post', [$this, 'ajax_translate_post']);
    }
    ...
    public function render_keys_page(): void
    {
        ...
        echo '<div class="wrap">';
        echo '<h1>' . esc_html__('API Keys Management', 'wp-smart-translation-engine') . '</h1>';
        echo '<p>' . esc_html__('API keys management interface will be implemented here.', 'wp-smart-translation-engine') . '</p>';
        echo '</div>';
    }
    ...
    {
        $settings = get_option('wpste_settings', []);
        $enabled_langs = $settings['enabled_languages'] ?? ['en'];
    ...
    public function enqueue_admin_assets(string $hook): void
    {
        if ($hook === 'post.php' || $hook === 'post-new.php') {
            ...
            wp_localize_script('wpste-admin', 'wpste', [
